                            ...
                            <div className="max-w-3xl mx-auto">
                                ...
                                <div className="grid grid-cols-3 gap-2 md:gap-3 mt-3">
                                    ...
                                    <div className="bg-gray-100 rounded-b-2xl py-3 md:py-4 px-1.5 md:px-4 text-center flex items-center justify-center">
                                        <Link
                                            to="/customize"
                                            className="inline-flex items-center justify-center gap-1 w-full max-w-[140px] md:w-auto bg-[#dc2626] text-white hover:bg-[#b91c1c] px-1 md:px-5 py-2 md:py-2.5 rounded-full font-body font-bold text-[10px] md:text-xs transition-all duration-200 shadow-md"
                                        >
                                            <span className="md:whitespace-nowrap">Get Started</span> <ArrowRight className="w-3 h-3 md:w-3.5 md:h-3.5 flex-shrink-0" />
                                        </Link>
                                    </div>
                    ...
                    <section className="py-6 bg-[#faf5f0]">
                        <div className="container mx-auto px-4 max-w-5xl">
                            <div className="px-6 py-4 md:px-10 md:py-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 justify-center items-center place-items-center gap-x-4 gap-y-8 md:gap-x-10 md:gap-y-12 max-w-4xl mx-auto">
